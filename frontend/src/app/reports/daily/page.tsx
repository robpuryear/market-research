    ...
    <div className="p-6 max-w-7xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-gray-800 font-mono">Daily Market Report</h1>
        </div>
        <div className="flex items-center gap-3">
          <GenerateReportButton type="daily" label="Regenerate" />
          {id && <DownloadButton reportId={id} filename="daily-market-report.html" />}
        </div>
      </div>
      {id ? (
